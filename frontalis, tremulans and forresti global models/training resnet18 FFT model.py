...
# ── USER SETTINGS ───────────────────────────────────────────────
DATA_DIR        = '/Volumes/DL Project SSD/back subtracted method data/forresti, tremulans, frontalis input and output data/DL ready training input dataset'
BEST_MODEL_PATH = '/Users/arnavps/Desktop/RA info/New Deep Learning project/TESTING_CODE/background subtraction detection method/actual background subtraction code/frontalis, tremulans and forresti global models/resnet18_FFT_best_model.pt'
EPOCHS, BATCH_SIZE, LR = 20, 128, 3e-4
NUM_WORKERS = 2
