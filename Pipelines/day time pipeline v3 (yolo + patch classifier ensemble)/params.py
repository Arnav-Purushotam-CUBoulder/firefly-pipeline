...
ROOT: str | Path = "/mnt/Samsung_SSD_2TB/temp to delete/day time pipeline inference output data"
...
# Standalone direct runs should default to the latest known global day patch model.
DEFAULT_DAY_PATCH_MODEL_PATH: Path = Path(
...
YOLO_MODEL_WEIGHTS: Path = Path("/mnt/Samsung_SSD_2TB/integrated prototype data/v3 daytime YOLO model data/models/global models/20260414/best_firefly_yolo.pt")
...
PATCH_MODEL_PATH: Path = DEFAULT_DAY_PATCH_MODEL_PATH
