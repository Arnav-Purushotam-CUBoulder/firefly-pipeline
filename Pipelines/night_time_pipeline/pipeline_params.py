...
DIR_STAGE14_OUT = ROOT / 'stage14 detection summaries'
...
CNN_MODEL_PATH = Path(
    ...
    "tmp_day_night_combo_train_and_infer__20260305__163237/models/night/global_all_species.pt"
)
...
# Stage 8.5 / 9 shared
MIN_PIXEL_BRIGHTNESS_TO_BE_CONSIDERED_IN_AREA_CALCULATION = 30
