...
INPUT_CSV   = Path('/Users/arnavps/Desktop/FFT resnet fixing FPs/forresti inference data/csv files/fixed_to_center_chopped_Forresti_C0107.csv')     # your CSV/TSV file
INPUT_VIDEO = Path('/Volumes/DL Project SSD/back subtracted method data/resnet forresti data/raw input videos/chopped_Forresti_C0107.MP4')           # your video file
OUTPUT_DIR  = Path("forresti, fixing FPs and box overlap/Proof of concept code/test1/bug fixing forresti/bug fixing data/output crops")        # where 10x10 crops will be written
...
OUTPUT_LOGITS_CSV = Path("forresti, fixing FPs and box overlap/Proof of concept code/test1/bug fixing forresti/bug fixing data/output_logits.csv")
